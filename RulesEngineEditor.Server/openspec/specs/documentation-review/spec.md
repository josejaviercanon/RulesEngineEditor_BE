...
Define requirements for reviewing and updating existing project documentation to reflect current project state, agent role assignments, and tooling configuration.
