...
Define the conventions, project layout, tooling, and patterns for writing unit tests and infrastructure tests against `RulesController` endpoints. Tests reside under `./Testing/` at the `src/BE/` root, separate from production code.
