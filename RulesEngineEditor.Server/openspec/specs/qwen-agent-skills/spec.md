...
Define requirements for creating Qwen model agent skill files that mirror the existing Deepseek agent skill file conventions. Qwen agents share the same technology stack and workflows as Deepseek agents, with model-specific assignments.
