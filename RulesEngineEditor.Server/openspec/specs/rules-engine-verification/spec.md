...
The Rules Engine Verification capability provides structural deep-comparison between a `RuleResultTree` and an expected output JSON string, returning pass/fail status with detailed diffs. This enables automated test scenario validation.
